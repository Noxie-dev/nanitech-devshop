      ...
      <div className="glass-card rounded-2xl p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-[#EAEAEA]/40" />
                <input
                  type="text"
                  name="firstName"
          ...
          <div>
            ...
            <p className="text-xs text-[#EAEAEA]/50 mt-1">
          ...
          <div className="flex items-start">
            <input
              type="checkbox"
              required
              className="w-4 h-4 text-[#00E5FF] bg-[#1C1F27] border-[#2A2D3A] rounded focus:ring-[#00E5FF] focus:ring-2 mt-1"
            />
            <span className="ml-2 text-sm text-[#EAEAEA]/70">
              I agree to the{' '}
              <a href="/terms" className="text-[#00E5FF] hover:text-[#00E5FF]/80">
                Terms of Service
              </a>{' '}
              and{' '}
              <a href="/privacy" className="text-[#00E5FF] hover:text-[#00E5FF]/80">
                Privacy Policy
              </a>
            </span>
          </div>
        ...
        <div className="mt-6 text-center">
          <span className="text-[#EAEAEA]/70">Already have an account? </span>
          <button
